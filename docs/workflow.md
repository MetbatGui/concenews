...
- **🔴 Bug·🔵 Nit 은 자동 수정**하고, `just check-branch-green`·커밋·push 후 `# Independent Review 조치` 댓글에 변경과 검증 결과를 기록한다. **🟡 Risk·❓ Question 은 사용자 결정**을 받은 뒤 진행한다 ([ADR 2026-08-14](decisions/2026-08-14-review-response-policy.md)).
